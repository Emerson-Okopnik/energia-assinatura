                ...
                <div class="col-md-12">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-4">
                            ...
                            <input id="data_ass_contrato" type="date" class="form-control"
                                v-model="form.data_ass_contrato" />
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row">
                        <div v-for="(mesLabel, mesKey) in meses" :key="mesKey" class="col-2 mb-2">
                            ...
                            <input :id="'consumo-' + mesKey" type="number" class="form-control"
                    ...
                    <div class="row mb-4 mt-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input id="menorGeracao" type="number" class="form-control" :value="menorGeracao"
                                readonly />
                        </div>
                    </div>
                    ...
                    <div class="mb-3 col-md-4">
                        ...
                        <input id="valorfinalmedio" type="number" class="form-control"
                    ...
                    <div class="row mb-2">
                        <div class="col-md-4">
                            ...
                            <input id="previsaoconexao" type="date" class="form-control"
    ...
    methods: {
        ...
        async submitForm() {
            try {
                ...
                this.errorMessage = "";
                setTimeout(() => {
                    this.$router.push('/usinas'); // ou { name: 'listar-usinas' }
